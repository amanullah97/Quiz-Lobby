...
from .validators import csv_file_validator, validate_file
...
class Quiz(models.Model):
    ...
    start_datetime = models.DateTimeField('start-datetime', blank=False)
    end_datetime = models.DateTimeField('end-datetime', blank=False)
